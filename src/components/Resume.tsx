...
export const Resume = () => {
  return (
    <div className="max-w-[420px] rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      {/*        <Image src={role.logo} alt="Logo" className="h-7 w-7 rounded-full object-cover" unoptimized />*/}
      {/*      </div>*/}
      {/*      <dl className="flex flex-auto flex-wrap gap-x-2">*/}
      {/*        <dt className="sr-only">Company</dt>*/}
      {/*        <dd className="flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">{role.company}</dd>*/}
